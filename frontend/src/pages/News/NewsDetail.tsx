...
const NewsDetail: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{news?.title} | World News</title>
        <meta name="description" content={news?.description?.substring(0, 160)} />
        <meta name="keywords" content={`${news?.category}, news, ${news?.title}`} />
        <meta property="og:title" content={news?.title} />
        <meta property="og:description" content={news?.description?.substring(0, 160)} />
        <meta property="og:image" content={getImageUrl(news?.image)} />
        <meta property="og:url" content={`https://worldnew.in/news/${news?._id}`} />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={news?.title} />
        <meta name="twitter:description" content={news?.description?.substring(0, 160)} />
        <meta name="twitter:image" content={getImageUrl(news?.image)} />
        <link rel="canonical" href={`https://worldnew.in/news/${news?._id}`} />
      </Helmet>
      <div className="flex min-h-screen bg-gray-50">
        <Sidebar />
        <div className="flex-1 w-full lg:w-auto p-4 lg:p-6">
