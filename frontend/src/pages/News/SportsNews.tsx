      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-[1280px] mx-auto px-4 py-20">
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-xl font-medium text-gray-700">Loading sports news...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-[1280px] mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600">No sports news available</p>
      ...
      <div className="max-w-[1280px] mx-auto px-4 py-6">
        ...
        <header className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Sport</h1>
          </div>
          <p className="text-base text-gray-600">
            The latest sports news, live scores, results and analysis from around the world.
          </p>
        </header>
          ...
          <div className="lg:col-span-2 lg:border-r border-gray-200 lg:pr-6">
            <a href={`/news/${heroArticle.slug || heroArticle._id}`} className="block group">
              ...
              <div className="space-y-3">
                <span className="inline-block px-2 py-1 bg-yellow-600 text-white text-xs font-bold uppercase">
                  Sport
                </span>
        ...
        <div className="py-8">
          ...
          <div className="space-y-6">
            {listArticles.map((news, index) => (
              <div key={news._id}>
                <a href={`/news/${news.slug || news._id}`} className="block group">
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-bold text-gray-900 line-clamp-2 group-hover:text-red-600 transition-colors">
                      {news.title}
                    </h4>
